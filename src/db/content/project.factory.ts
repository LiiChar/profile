...
const projectContent: ProjectFactoryInsert[] = [
	{
		...
		content:
			'Приложение, которое помогает авторам генерировать идеи, строить сюжетные арки и редактировать текст с помощью AI.',
	...
	},
	{
		...
		content:
			'React/Next.js приложение с поддержкой видеоуроков, квизов и сертификатов.',
	...
	},
	{
		...
		content:
			'Минималистичное приложение для отслеживания привычек с графиками и аналитикой.',
	...
	},
	{
		...
		content:
			'Безопасное приложение для обмена сообщениями, реализующее протокол Signal.',
	...
	},
	{
		...
		content:
			'Мобильное SPA с упражнениями для медитации, дыхания и релаксации.',
	...
	},
	{
		...
		content:
			'Инструмент для отслеживания бюджета, расходов и доходов с красивыми графиками.',
	...
	},
	{
		...
		content:
			'AI-бот, который предлагает идеи на основе рыночных трендов и интересов пользователя.',
	...
	},
	{
		...
		content:
			'Шаблонный сайт на Next.js с анимацией, разделами и адаптивной вёрсткой.',
	...
	},
	{
		...
		content:
			'Платформа для загрузки, продажи и покупки NFT с использованием Ethereum.',
